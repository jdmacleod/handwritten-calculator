...
function captureItem(e) {
  ...
  var symbolName = symbolSelect.options[symbolSelect.selectedIndex].text;

  // generate a unique identifier for the posted image
  // see https://stackoverflow.com/questions/1320568/best-way-to-generate-unique-ids-client-side-with-javascript
  // https://stackoverflow.com/questions/105034/how-do-i-create-a-guid-uuid
  uuid = uuidv4();
  console.log(uuid);
...
function updateSymbolExample() {
  var symbolSelect = document.getElementById("symbolSelect");
  var selectedValue = symbolSelect.value;
  symbolEl.textContent = selectedValue;
}
